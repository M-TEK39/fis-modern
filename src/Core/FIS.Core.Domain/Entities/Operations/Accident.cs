...
public class Accident
{
    ...
    [NotMapped]
    public string? captured_person { get; set; }
    ...
    [NotMapped]
    public string? driver_telno { get; set; }

    [NotMapped]
    public short? driver_site_code { get; set; }
    ...
    [NotMapped]
    public decimal? accident_km { get; set; }
    ...
    [NotMapped]
    public string? third_party_tel { get; set; }

    [NotMapped]
    public decimal? third_party_claim { get; set; }

    [NotMapped]
    public string? SecondThirdPartyRegNo { get; set; }
    ...
    [NotMapped]
    public string? docs_acc_relieve { get; set; }

    [NotMapped]
    public string? flag_case_num { get; set; }
    ...
    [NotMapped]
    public string? attorney_insure { get; set; }
