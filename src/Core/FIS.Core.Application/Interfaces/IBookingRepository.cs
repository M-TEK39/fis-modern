...
public interface IBookingRepository
{
    ...
    Task<Booking> CreateAsync(Booking booking, int currentUserId);
    Task<Booking> UpdateAsync(Booking booking, int currentUserId);
    Task DeleteAsync(short bookingId, int currentUserId);
}
