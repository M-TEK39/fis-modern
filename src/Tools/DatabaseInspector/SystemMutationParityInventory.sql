...
VALUES
    ...
    (N'Contracts', N'List pending contracts that require action', N'contract', N'DEV_SEL_Contract_ActionRequired', NULL),
    (N'Contracts', N'List pending backdating contracts that require authorisation', N'contract', N'DEV_SEL_Contract_BackDatingAuthorisation_ActionRequired', NULL),
...
VALUES
    ...
    (N'Finance Tariff Parameters', N'List fiscal years for tariff parameter management', N'fin', N'TariffParameter', N'DEV_SEL_TariffParameter_Lookup', NULL),
    (N'Finance Tariff Parameters', N'Show tariff parameters for a selected fiscal year', N'fin', N'TariffParameter', N'DEV_SEL_TariffParameter_ByTariffParameterID', NULL),
    (N'Finance Tariff Parameters', N'List overheads for a selected fiscal year', N'fin', N'Overhead', N'DEV_SEL_Overhead_ByTariffParameterID', NULL),
    (N'Finance Tariff Parameters', N'List maintenance values for a selected fiscal year', N'fin', N'MaintenanceValue', N'DEV_SEL_MaintenanceValues_ByTariffParameterID', NULL),
...
VALUES
    ...
    (N'Contracts', N'DEV_SEL_Contract_ActionRequired', 1, N'@UserDeptCode', N'MNT_Vehicle_Contract.aspx.vb sdsContractToAction; Repeater Eval contract_code'),
    (N'Contracts', N'DEV_SEL_Contract_ActionRequired', 2, N'@UserSiteCode', N'MNT_Vehicle_Contract.aspx.vb sdsContractToAction; Repeater Eval contract_code'),
    (N'Contracts', N'DEV_SEL_Contract_ActionRequired', 3, N'@UserSiteContextOnly', N'MNT_Vehicle_Contract.aspx.vb txtLoginUserSiteContextOnly dept 147 or VehicleListForAllSitesInDepartment'),
    (N'Contracts', N'DEV_SEL_Contract_BackDatingAuthorisation_ActionRequired', 1, N'@UserDeptCode', N'MNT_Vehicle_Contract_BackDating_Authorise.aspx.vb sdsContractToAction; Repeater Eval contract_code'),
    (N'Contracts', N'DEV_SEL_Contract_BackDatingAuthorisation_ActionRequired', 2, N'@UserSiteCode', N'MNT_Vehicle_Contract_BackDating_Authorise.aspx.vb sdsContractToAction; Repeater Eval contract_code'),
    (N'Contracts', N'DEV_SEL_Contract_BackDatingAuthorisation_ActionRequired', 3, N'@UserSiteContextOnly', N'MNT_Vehicle_Contract_BackDating_Authorise.aspx.vb txtLoginUserSiteContextOnly dept 147 or VehicleListForAllSitesInDepartment'),
    ...
    (N'Finance Tariff Parameters', N'DEV_SEL_TariffParameter_ByTariffParameterID', 1, N'@TariffParameterID', N'GGFIS_DataAccessLayer/Finance.vb GetTariffParameters_ByTariffParameterID; Fiscal_TariffParameter_Management.aspx.vb gvOverhead_General_Bind'),
    (N'Finance Tariff Parameters', N'DEV_SEL_Overhead_ByTariffParameterID', 1, N'@TariffParameterID', N'GGFIS_DataAccessLayer/Finance.vb GetOverheads_ByTariffParameterID; Fiscal_TariffParameter_Management.aspx.vb gvOverheads_Bind OverheadTypeID 1 Fixed / 2 Kilo'),
    (N'Finance Tariff Parameters', N'DEV_SEL_MaintenanceValues_ByTariffParameterID', 1, N'@TariffParameterID', N'GGFIS_DataAccessLayer/Finance.vb GetMaintenanceValues_ByTariffParameterID; Fiscal_TariffParameter_Management.aspx.vb gvMaintenanceValues_Bind'),
