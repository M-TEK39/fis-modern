...
public class VehicleOrderController : BaseApiController
{
    ...
    public VehicleOrderController(
        IVehicleOrderRepository repository,
    ...
    [HttpGet]
    public async Task<ActionResult<IEnumerable<VehicleOrder>>> GetAll()
    {
        try
        {
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<VehicleOrder>> GetById(int id)
    {
        try
        {
    ...
    [HttpPost]
    public async Task<ActionResult<VehicleOrder>> Create([FromBody] VehicleOrder item)
    {
        try
        {
    ...
    [HttpPut("{id}")]
    public async Task<ActionResult<VehicleOrder>> Update(int id, [FromBody] VehicleOrder item)
    {
        try
        {
            if (id != item.order_id)
