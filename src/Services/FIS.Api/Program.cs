...
builder.Services.AddScoped<LegacyFinanceRequestScopeFilter>();
builder.Services.AddScoped<LegacyFinanceDataAuthorizationFilter>();
builder.Services.AddScoped<LegacyFinanceHeadOfficeAuthorizationFilter>();
builder.Services.AddScoped<LegacyFinanceDepartment147AuthorizationFilter>();
builder.Services.AddScoped<LegacyFinanceCoisAuthorizationFilter>();
builder.Services.AddScoped<LegacyFinanceBatchAuthorizationFilter>();
builder.Services.AddScoped<LegacyFinanceTariffParametersAuthorizationFilter>();
builder.Services.AddScoped<LegacyFinanceTariffApproverAuthorizationFilter>();
builder.Services.AddScoped<LegacyFinanceOwnDepartmentDataAuthorizationFilter>();
builder.Services.AddScoped<LegacyFinanceBillingHistoryAuthorizationFilter>();
