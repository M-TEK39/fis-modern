...
async function LegacyAssetVerificationAddDetailsContent({
  searchParams,
...
export default function LegacyAssetVerificationAddDetails(
  props: Readonly<{ searchParams: SearchParams }>,
) {
  return (
    <StreamedRoute>
      <LegacyAssetVerificationAddDetailsContent {...props} />
    </StreamedRoute>
  );
}
