...
async function LegacyAccidentShowDetailPageContent({ searchParams }: IncidentCapturePageProps) {
...
export default function LegacyAccidentShowDetailPage(props: IncidentCapturePageProps) {
  return (
    <StreamedRoute>
      <LegacyAccidentShowDetailPageContent {...props} />
    </StreamedRoute>
  );
}
