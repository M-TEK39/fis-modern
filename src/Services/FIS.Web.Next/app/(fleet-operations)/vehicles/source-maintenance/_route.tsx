...
export type VehicleSourcePageProps = {
...
async function VehicleSourcePageContent({
  searchParams,
...
export default function VehicleSourcePage(props: VehicleSourcePageProps) {
  return (
    <Suspense fallback={<RouteLoading />}>
      <VehicleSourcePageContent {...props} />
    </Suspense>
  );
}
