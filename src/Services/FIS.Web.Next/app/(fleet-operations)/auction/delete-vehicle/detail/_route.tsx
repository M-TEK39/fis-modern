...
import { deleteAuctionAction } from "@/app/(fleet-operations)/auction/actions";
...
async function AuctionDeleteDetailPageContent({
  searchParams,
...
export default function AuctionDeleteDetailPage(props: AuctionDeleteDetailPageProps) {
  return (
    <StreamedRoute>
      <AuctionDeleteDetailPageContent {...props} />
    </StreamedRoute>
  );
}
