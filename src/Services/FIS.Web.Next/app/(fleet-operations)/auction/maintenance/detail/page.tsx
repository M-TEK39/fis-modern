...
function AuctionForm({
  ...
  updated,
  error,
}: Readonly<{ auction: AuctionRecord; routePath: string; updated: boolean; error?: string }>) {
  return (
    <form className="vehicle-status-maintenance-panel" action={saveAuctionMaintenanceAction}>
      ...
      <input
        name="returnPath"
        type="hidden"
        value={`${routePath}?auctionId=${auction.auctionCode}`}
      />
      {updated ? (
      ...
      <div className="vehicle-form-section-header">
        <div>
          ...
          <h2>Edit Auction #{auction.auctionCode}</h2>
          <p>
      ...
      <div className="button-row">
        ...
        <Link className="button button-secondary" href="/auction/maintenance">
          Menu
        </Link>
      </div>
    </form>
...
export default async function AuctionDetailPage({
    ...
    return (
      <main className="page-shell vehicle-page-shell">
        <section className="vehicle-status-card" role="alert">
          ...
          <h2>Select an auction record from the maintenance list.</h2>
          <Link className="button button-secondary" href="/auction/maintenance">
            Back to Auction
          </Link>
        </section>
  ...
  try {
        ...
        <section className="vehicle-card" aria-labelledby="auction-detail-title">
          <header className="vehicle-page-header">
            <div>
              ...
              <h1 id="auction-detail-title">Auction Maintenance Detail</h1>
              <p>Update the complete legacy auction and vehicle sale record.</p>
            </div>
    ...
    console.error(
      "FIS auction detail request failed",
