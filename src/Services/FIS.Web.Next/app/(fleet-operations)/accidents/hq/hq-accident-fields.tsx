...
type HqTimingFieldsProps = HqFieldSectionProps & {
  sites: readonly AccidentSiteOption[];
  isAdd: boolean;
  today: string;
...
type HqAmountFieldProps = HqFieldSectionProps & {
  amountDefault: number | "";
};
      ...
      <div className="vehicle-create-grid">
        <Field id="occurenceDate" label="Accident date" required>
          <input
            ...
            name="occurenceDate"
            type="date"
            defaultValue={dateInputValue(values.occurenceDate) || today}
            required
          />
        </Field>
        <Field id="occurenceTime" label="Accident time">
          <input
            ...
            name="occurenceTime"
            type="time"
            defaultValue={timeInputValue(values.occurenceTime)}
          />
        </Field>
        ...
        <Field id="accidentKm" label="GG car km" required>
          <input
            ...
            min="0"
            step="1"
            defaultValue={values.accidentKm ?? amountDefault}
            required
          />
        </Field>
        <SelectField
        ...
        {!isAdd ? (
          <Field id="dateUpdated" label="Date updated">
            <input
              id="dateUpdated"
              type="text"
              value={dateInputValue(values.dateUpdated)}
              readOnly
            />
          </Field>
        ) : null}
...
function HqNotificationsFields({ values, isAdd }: HqNotificationsFieldsProps) {
  return !isAdd ? (
      ...
      <div className="vehicle-create-grid">
        ...
        <Field id="flagGgHqDate" label="Notify garage date">
          <input
            id="flagGgHqDate"
            type="date"
            value={dateInputValue(values.flagGgHqDate)}
            readOnly
          />
        </Field>
        ...
        <Field id="flagTripAuthDate" label="Notify trip date">
          <input
            id="flagTripAuthDate"
            type="date"
            value={dateInputValue(values.flagTripAuthDate)}
            readOnly
          />
        </Field>
      </div>
...
function HqDetailsFields({ values }: HqFieldSectionProps) {
  return (
      ...
      <div className="vehicle-create-grid">
        ...
        <Field id="driverName" label="GG driver name">
          <input
            ...
            type="text"
            maxLength={25}
            defaultValue={values.driverName ?? ""}
          />
        </Field>
        <Field id="driverEmployNumber" label="Driver ID number">
          <input
            ...
            maxLength={13}
            inputMode="numeric"
            defaultValue={values.driverEmployNumber ?? ""}
          />
        </Field>
      ...
      <div className="vehicle-create-grid">
        ...
        <Field id="saReference" label="SA reference">
          <input
            ...
            type="text"
            maxLength={20}
            defaultValue={values.saReference ?? ""}
          />
        </Field>
...
function HqDamageFields({ values, amountDefault }: HqAmountFieldProps) {
  return (
      ...
      <div className="vehicle-create-grid">
        <Field id="costOfRepair" label="GG car damage" required>
          <input
            ...
            min="0"
            step="0.01"
            defaultValue={values.costOfRepair ?? amountDefault}
            required
          />
        </Field>
        ...
        <Field id="thirdPartyClaim" label="Private car damage" required>
          <input
            ...
            min="0"
            step="0.01"
            defaultValue={values.thirdPartyClaim ?? amountDefault}
            required
          />
        </Field>
...
function HqClaimFields({ values, amountDefault }: HqAmountFieldProps) {
  return (
      ...
      <div className="vehicle-create-grid">
        ...
        <Field id="claimAmount" label="Claim amount" required>
          <input
            ...
            min="0"
            step="0.01"
            defaultValue={values.claimAgainstDepartment ?? values.claimAmount ?? amountDefault}
            required
          />
        </Field>
        <SelectField
...
function HqCloseFields({ values, amountDefault }: HqAmountFieldProps) {
  return (
      ...
      <div className="vehicle-create-grid">
        <Field id="writeOffAmount" label="Write-off amount" required>
          <input
            ...
            min="0"
            step="0.01"
            defaultValue={values.writeOffAmount ?? amountDefault}
            required
          />
        </Field>
...
export default function HqAccidentFields({
  values = {},
  sites,
  mode,
  today = "",
