...
function getHqDeleteTableColumns(
  ...
  return (
    <>
      <div className="vehicle-table-wrapper" aria-live="polite">
        <VehicleTable
          caption="HQ accident records available for deletion"
          columns={getHqDeleteTableColumns(searchType, searchTerm)}
          rows={pageData.rows}
...
async function HqDeleteContent({ searchParams }: HqDeletePageProps) {
  ...
  return (
    <>
      ...
      <HqDeleteSearchForm searchType={searchType} searchTerm={searchTerm} />
      <HqDeleteResults pageData={pageData} searchType={searchType} searchTerm={searchTerm} />
