...
import GarageAddForm from "@/app/(fleet-operations)/accidents/garage/add/garage-add-form";
import {
  AccidentApiError,
...
export default function GarageAddPage({ searchParams }: GarageAddPageProps) {
  return (
