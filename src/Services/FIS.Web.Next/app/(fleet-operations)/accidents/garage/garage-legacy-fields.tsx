...
type GarageFieldSectionProps = {
  values: Partial<LegacyFieldValues>;
};

type GarageWorkflowFieldsProps = GarageFieldSectionProps & {
  sites: readonly AccidentSiteOption[];
  accidentTypes: readonly AccidentTypeOption[];
};
...
function GaragePeopleFields({ values }: GarageFieldSectionProps) {
  return (
...
function GarageCaseFields({ values }: GarageFieldSectionProps) {
  return (
...
function GarageThirdPartyFields({ values }: GarageFieldSectionProps) {
  return (
...
function GarageDocumentFields({ values }: GarageFieldSectionProps) {
  return (
...
function GarageNotesFields({ values }: GarageFieldSectionProps) {
  return (
...
export default function GarageLegacyFields({
  ...
  return (
    <>
      <GarageWorkflowFields values={values} sites={sites} accidentTypes={accidentTypes} />
      <GaragePeopleFields values={values} />
      <GarageCaseFields values={values} />
      <GarageThirdPartyFields values={values} />
      <GarageDocumentFields values={values} />
      <GarageNotesFields values={values} />
    </>
  );
}
