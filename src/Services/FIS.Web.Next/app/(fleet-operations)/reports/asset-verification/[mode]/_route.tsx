...
export function AssetVerificationReportPage(props: AssetVerificationReportPageProps) {
  return (
    <StreamedRoute>
...
async function AssetVerificationReportRouteContent({
  ...
  return (
    <AssetVerificationReportPageContent
...
export default function AssetVerificationReportRoute(
  props: Readonly<{
  ...
  return (
    <StreamedRoute>
      <AssetVerificationReportRouteContent {...props} />
    </StreamedRoute>
  );
}
