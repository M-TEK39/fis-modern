...
import { FuelCardNotice } from "@/app/(fleet-operations)/fuel-cards/_components";
import { MenuSection } from "@/components/ui/menu-section";
import { getFuelCardAllocation, FuelCardApiError } from "@/lib/api/fleet-operations/api-fuel-cards";
...
async function FuelCardsPageContent({
  searchParams,
...
export default function FuelCardsPage(props: Parameters<typeof FuelCardsPageContent>[0]) {
  return (
    <Suspense fallback={<RouteLoading />}>
      <FuelCardsPageContent {...props} />
    </Suspense>
  );
}
