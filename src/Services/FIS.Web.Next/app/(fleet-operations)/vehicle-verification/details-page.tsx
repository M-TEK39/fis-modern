  ...
  try {
    ...
    if (exactMatches.length !== 1)
      return (
        <ErrorCard
          title={
            exactMatches.length === 0 ? "Vehicle not found." : "Vehicle selection is ambiguous."
          }
          message={
    ...
    return (
      <ErrorCard
        ...
        message="The vehicle or compatible Asset_Verification data could not be loaded. Retry when the FIS API is available."
        backHref={`/vehicle-verification/${mode}`}
      />
    );
  }
