...
export default async function LogsheetHelpPage() {
  ...
  return (
    <LogsheetShell
      title="Logsheet Maintenance Information / Help"
      description="Use this workflow to capture and report monthly vehicle usage."
    >
      <section className="vehicle-status-maintenance-panel">
        <h2>Logsheet workflow</h2>
        <ol>
          ...
          <li>Use the reports to review captured activity or total kilometres by vehicle class.</li>
          <li>
