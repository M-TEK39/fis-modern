...
import { deleteTowingAction, saveTowingAction } from "@/app/(fleet-operations)/towing/actions";
...
export default function TowingDetailPage(props: Parameters<typeof TowingDetailPageContent>[0]) {
  return (
