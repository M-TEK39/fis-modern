  ...
  if (session.status === "expired")
    return (
      <main className="page-shell vehicle-page-shell">
        <SessionRecovery returnPath="/towing/reports" />
      </main>
    );
    ...
    return (
      <main className="page-shell vehicle-page-shell">
        <section className="vehicle-status-card" role="alert">
          ...
          <h2>Towing reports could not be opened.</h2>
    ...
    return (
      <main className="page-shell vehicle-page-shell">
        <section className="vehicle-status-card" role="alert">
          ...
          <h2>You do not have permission to access Towing reports.</h2>
          <p className="muted-copy">This menu requires the legacy Reports role.</p>
        </section>
      </main>
    );
      ...
      <section className="vehicle-card" aria-labelledby="towing-reports-title">
        <header className="vehicle-page-header">
          <div>
            ...
            <h1 id="towing-reports-title">Road Side Assistance Report Menu</h1>
            <p>Run the report workflows available in the legacy Towing menu.</p>
          </div>
        ...
        <section className="vehicle-menu-tile">
          ...
          <div className="vehicle-menu-body">
            <Link className="vehicle-menu-link" href="/towing/reports/request">
              1) Road Side Assistance Request Report
            </Link>
          </div>
        </section>
        <section className="vehicle-menu-tile">
          ...
          <div className="vehicle-menu-body">
            <Link className="vehicle-menu-link" href="/towing/tow-truck-data/report">
              1) All Assistance Firm General Data
            </Link>
            <Link className="vehicle-menu-link" href="/towing/reports/firm-date">
              2) Road Side Call&apos;s for a Firm
            </Link>
          </div>
        </section>
      </section>
