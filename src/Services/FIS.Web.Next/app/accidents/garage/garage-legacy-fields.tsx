...
import type { AccidentEditRecord, AccidentSiteOption, AccidentTypeOption } from "@/lib/api-accidents";
...
function SelectField({
  ...
  value,
  children,
}: Readonly<{ id: string; label: string; name: string; value: string | number | null | undefined; children: ReactNode }>) {
  return (
...
function YesNoField({
  ...
  value,
  unknown = false,
}: Readonly<{ id: string; label: string; name: string; value: string | null | undefined; unknown?: boolean }>) {
  return (
  ...
  return (
    <>
      <section className="vehicle-form-section" aria-labelledby="garage-legacy-workflow-title">
        ...
        <div className="vehicle-create-grid">
          ...
          <Field id="accidentKm" label="GG car km">
            <input id="accidentKm" name="accidentKm" type="number" min="0" step="1" defaultValue={values.accidentKm ?? 0} />
          </Field>
          <SelectField id="accidentTypeCode" label="Accident category" name="accidentTypeCode" value={values.accidentTypeCode}>
            <option value="">Not set</option>
            {accidentTypes.map((type) => (
              <option key={type.typeCode} value={type.typeCode}>{type.description}</option>
            ))}
          </SelectField>
          ...
          <Field id="flagGgHqDate" label="Notify HQ date">
            <input id="flagGgHqDate" name="flagGgHqDate" type="date" defaultValue={dateInputValue(values.flagGgHqDate)} />
          </Field>
          <Field id="fileCloseDate" label="File close date">
            <input id="fileCloseDate" name="fileCloseDate" type="date" defaultValue={dateInputValue(values.fileCloseDate)} />
          </Field>
      ...
      <section className="vehicle-form-section" aria-labelledby="garage-legacy-people-title">
        ...
        <div className="vehicle-create-grid">
          <Field id="driverTelno" label="Driver telephone">
            <input id="driverTelno" name="driverTelno" type="tel" maxLength={30} defaultValue={values.driverTelno ?? ""} />
          </Field>
      ...
      <section className="vehicle-form-section" aria-labelledby="garage-legacy-case-title">
        ...
        <div className="vehicle-create-grid">
          <Field id="caseNumber" label="Case number">
            <input id="caseNumber" name="caseNumber" type="text" maxLength={15} defaultValue={values.caseNumber ?? ""} required />
          </Field>
          <Field id="reportingAuthority" label="Authority">
            <input id="reportingAuthority" name="reportingAuthority" type="text" maxLength={60} defaultValue={values.reportingAuthority ?? ""} />
          </Field>
          ...
          <Field id="costOfRepair" label="GG car damage">
            <input id="costOfRepair" name="costOfRepair" type="number" min="0" step="0.01" defaultValue={values.costOfRepair ?? 0} />
          </Field>
          <Field id="damageDescription" label="GG damage description">
            <textarea id="damageDescription" name="damageDescription" maxLength={60} rows={3} defaultValue={values.damageDescription ?? ""} />
          </Field>
      ...
      <section className="vehicle-form-section" aria-labelledby="garage-legacy-third-party-title">
        ...
        <div className="vehicle-create-grid">
          ...
          <Field id="thirdPartyTelephone" label="Private party telephone">
            <input id="thirdPartyTelephone" name="thirdPartyTelephone" type="tel" maxLength={30} defaultValue={values.thirdPartyTelephone ?? ""} />
          </Field>
          <Field id="thirdPartyClaim" label="Private car damage">
            <input id="thirdPartyClaim" name="thirdPartyClaim" type="number" min="0" step="0.01" defaultValue={values.thirdPartyClaim ?? 0} />
          </Field>
          <Field id="secondThirdPartyRegNo" label="2nd third-party registration">
            <input id="secondThirdPartyRegNo" name="secondThirdPartyRegNo" type="text" maxLength={8} defaultValue={values.secondThirdPartyRegNo ?? ""} />
          </Field>
          <YesNoField id="claimReceived" label="Claim received" name="claimReceived" value={values.claimReceived ?? "N"} />
          <Field id="claimAmount" label="Claim amount">
            <input id="claimAmount" name="claimAmount" type="number" min="0" step="0.01" defaultValue={values.claimAgainstDepartment ?? 0} />
          </Field>
          <Field id="privateDamagePaymentDate" label="Private damage payment date">
            <input id="privateDamagePaymentDate" name="privateDamagePaymentDate" type="date" defaultValue={dateInputValue(values.privateDamagePaymentDate)} />
          </Field>
      ...
      <section className="vehicle-form-section" aria-labelledby="garage-legacy-documents-title">
        ...
        <div className="vehicle-create-grid">
          <YesNoField id="letterhead" label="Letterhead" name="letterhead" value={values.letterhead ?? "N"} />
          ...
          <YesNoField id="statement" label="Statement" name="statement" value={values.statement ?? "N"} />
          <YesNoField id="sketch" label="Sketch" name="sketch" value={values.sketch ?? "N"} />
          <SelectField id="tripAuthor" label="Trip / garage authority" name="tripAuthor" value={values.tripAuthor ?? "N"}>
            <option value="Y">Y</option>
            <option value="N">N</option>
          </SelectField>
          <YesNoField id="iddoc" label="ID document" name="iddoc" value={values.iddoc ?? "N"} />
          <YesNoField id="drivelic" label="Driving licence" name="drivelic" value={values.drivelic ?? "N"} />
          <YesNoField id="flagCaseNumber" label="Case number received" name="flagCaseNumber" value={values.flagCaseNumber ?? "N"} />
          <YesNoField id="documentsAccidentRelieve" label="Documents received for relief" name="documentsAccidentRelieve" value={values.documentsAccidentRelieve ?? "N"} />
          <SelectField id="flagTripAuthor" label="Notify trip authority" name="flagTripAuthor" value={values.flagTripAuthor ?? "N"}>
            <option value="N">N</option>
            <option value="Y">Y</option>
            <option value="X">X</option>
          </SelectField>
          <Field id="flagTripAuthDate" label="Notify trip date">
            <input id="flagTripAuthDate" name="flagTripAuthDate" type="date" defaultValue={dateInputValue(values.flagTripAuthDate)} />
          </Field>
      ...
      <section className="vehicle-form-section" aria-labelledby="garage-legacy-notes-title">
        ...
        <div className="vehicle-create-grid">
          ...
          <Field id="writeOffAmount" label="Write-off amount">
            <input id="writeOffAmount" name="writeOffAmount" type="number" min="0" step="0.01" defaultValue={values.writeOffAmount ?? ""} />
          </Field>
          <Field id="writeOffDate" label="Write-off date">
            <input id="writeOffDate" name="writeOffDate" type="date" defaultValue={dateInputValue(values.writeOffDate)} />
          </Field>
