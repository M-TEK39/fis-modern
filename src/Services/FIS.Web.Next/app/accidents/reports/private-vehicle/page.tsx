...
function LoadingState() {
  return (
    <div className="loading-card" aria-busy="true">
      ...
      <p>Loading private vehicle accident report...</p>
    </div>
  );
}
...
export async function PrivateVehicleReportPage({
  searchParams,
...
export default async function PrivateVehicleReportPageDefault({
  searchParams,
}: PrivateVehicleReportPageProps) {
