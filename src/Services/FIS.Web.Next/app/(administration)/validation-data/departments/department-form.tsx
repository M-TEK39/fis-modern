...
import type { DepartmentActionState } from "@/app/(administration)/validation-data/departments/actions";
...
function DepartmentDetailsSection({
  department,
  mode,
}: Readonly<{ department: DepartmentRecord; mode: "create" | "update" }>) {
  return (
...
function DepartmentAddressSection({ department }: Readonly<{ department: DepartmentRecord }>) {
  return (
...
function DepartmentContactSection({ department }: Readonly<{ department: DepartmentRecord }>) {
  return (
...
function DepartmentNotesSection({ department }: Readonly<{ department: DepartmentRecord }>) {
  return (
...
function DepartmentExpandedSection({ department }: Readonly<{ department: DepartmentRecord }>) {
  return (
      ...
      <div className="field-grid">
        ...
        <Field id="exportIsActive" label="Export active">
          <select
            ...
            name="exportIsActive"
            defaultValue={
              department.exportIsActive === null ? "" : department.exportIsActive ? "true" : "false"
            }
          >
            <option value="">Not specified</option>
            <option value="true">Active</option>
...
export default function DepartmentForm({
  ...
  return (
    <form action={formAction} className="vehicle-create-form">
      ...
      <DepartmentDetailsSection department={department} mode={mode} />

      <DepartmentAddressSection department={department} />

      <DepartmentContactSection department={department} />

      <DepartmentNotesSection department={department} />

      <DepartmentExpandedSection department={department} />
