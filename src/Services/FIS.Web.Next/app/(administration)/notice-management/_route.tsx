...
const NoticeManagementView = renderNoticeManagementView;

function renderNoticeManagementView({
  routePath,
  query,
  search,
  status,
  ...
  schedulePage: NoticeSchedulePage;
}>) {
  ...
  return (
    <main className="page-shell vehicle-page-shell">
      <section className="vehicle-card" aria-labelledby="notice-management-title">
        ...
        {resultMessage ? (
          <div
            className={saved ? "notice notice-success" : "notice notice-error"}
...
export function NoticeManagementContent(props: NoticeManagementPageProps) {
  return <>{renderNoticeManagementContent(props)}</>;
}

async function renderNoticeManagementContent({
  searchParams,
