...
const HELP_ENTRIES: readonly HelpEntry[] = [
  { term: "Date of Offence", description: "The date the offence was committed, as indicated on the fine." },
  { term: "Reference Number", description: "The unique reference number issued by the traffic authority." },
  { term: "Issued By", description: "The person or authority that issued the fine." },
  { term: "Traffic Dept.", description: "The traffic department or authority associated with the fine." },
  { term: "Amount of Fine", description: "The Rand value of the fine as shown on the notice." },
  { term: "Due Date of Payment", description: "The date by which payment is due to avoid prosecution." },
  { term: "Due Date to Appear in Court", description: "The date on which the recipient must appear in court, when applicable." },
  { term: "Document Type", description: "The type of document received for the fine." },
  { term: "Date Received at GMT", description: "The date the fine was received by fleet management." },
  { term: "Date of Notification to the Driver", description: "The date the driver was notified of the fine." },
  { term: "Dept Code", description: "The department code associated with the responsible vehicle or driver." },
  { term: "Responsible Person", description: "The name and ID number of the responsible person at the department." },
];
  ...
  return (
    <section className="vehicle-status-card" role="alert">
      ...
      <div className="button-row">
        <Link className="button button-primary" href="/fines/help">Try again</Link>
...
export default async function FinesHelpPage() {
  ...
  if (session.status === "expired") {
    return <main className="page-shell vehicle-page-shell"><SessionRecovery returnPath="/fines/help" /></main>;
  }
    ...
    <main className="page-shell vehicle-page-shell">
      <article className="vehicle-card" aria-labelledby="fines-help-title">
        ...
        <section aria-labelledby="fines-help-purpose-title">
          ...
          <p>
            The Fines program provides a uniform process for capturing traffic fines and analysing the outcome of
            those matters.
          </p>
        </section>
        ...
        <section aria-labelledby="fines-help-fields-title">
          ...
          <p>The definitions below describe the fields used throughout the Fines maintenance screens.</p>
          <div className="vehicle-table-wrapper">
            <table className="vehicle-table">
              <caption className="sr-only">Fines maintenance terms and field definitions</caption>
              <thead>
                <tr><th scope="col">Term / Field</th><th scope="col">Definition</th></tr>
              </thead>
              <tbody>
                {HELP_ENTRIES.map((entry) => (
                  <tr key={entry.term}><th scope="row">{entry.term}</th><td>{entry.description}</td></tr>
                ))}
              </tbody>
            </table>
          </div>
