            ...
            <tr key={auction.auctionCode}>
              ...
              <td>
                <Link
                  ...
                  href={buildDetailHref(auction.auctionCode)}
                >
                  DELETE
                </Link>
              </td>
...
export default async function AuctionDeletePage({
  ...
  try {
        ...
        <section className="vehicle-card" aria-labelledby="auction-delete-title">
          <header className="vehicle-page-header">
            <div>
              ...
              <h1 id="auction-delete-title">Delete a Vehicle on Auction</h1>
              <p>Find an auction record by GG or GP number, review it, then confirm deletion.</p>
            </div>
            <Link className="button button-secondary" href="/auction">
              Auction Menu
            </Link>
          ...
          {deleted ? (
            <div className="notice notice-success" role="status">
              Auction record deleted successfully.
            </div>
          ) : null}
          {error ? (
          ...
          <section
            ...
            aria-labelledby="auction-delete-results-title"
          >
            <div className="vehicle-form-section-header">
              <div>
                <p className="eyebrow">Johannesburg Garage</p>
                <h2 id="auction-delete-results-title">Auction records found</h2>
              </div>
            </div>
    ...
    console.error(
      "FIS auction deletion lookup failed",
