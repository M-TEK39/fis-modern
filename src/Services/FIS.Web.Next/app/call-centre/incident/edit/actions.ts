...
async function authorizeCallCentre(referenceNumber: string) {
  ...
  if (
    ...
    redirectWithError(
      "You do not have permission to update call centre incidents.",
      referenceNumber,
    );
  }
}
...
function getRequest(formData: FormData): UpdateCallCentreRequest {
  const request: UpdateCallCentreRequest = {
    ...
    IncidentDesc: validateMaxLength(
      formData,
    ...
    DriverPersalno: validateMaxLength(
      formData,
    ...
    DriverBaseStation: validateMaxLength(
      formData,
      "Driver base station",
      30,
      "Driver_base_station",
    ...
    TransportOfficerName: validateMaxLength(
      formData,
    ...
    TransportOfficerTel: validateMaxLength(
      formData,
    ...
    IncidentStreet: validateMaxLength(
      formData,
      "Incident street",
      30,
      "Incident_street",
    ...
    TransportOfficerFax: validateMaxLength(
      formData,
    ...
    TransportOfficerEmail: validateMaxLength(
      formData,
      "Transport officer email",
      240,
      "TrOfficer_email",
      "transportOfficerEmail",
    ),
    ...
    IncidentRemarks: validateMaxLength(
      formData,
      "Incident remarks",
      80,
      "Incident_Remarks",
...
function getAccidentUpdate(formData: FormData): AccidentEditUpdate {
  return {
    ...
    DriverEmployNumber: validateMaxLength(
      formData,
      "Accident driver Persal number",
      15,
      "Driver_persalno",
    ),
    ...
    TransportOfficerName: validateMaxLength(
      formData,
      "Accident transport officer name",
      30,
      "TrOfficer_name",
    ),
    TransportOfficerTel: validateMaxLength(
      formData,
      "Accident transport officer telephone",
      30,
      "TrOfficer_tel",
    ),
    ...
    ThirdPartyRegistration: validateMaxLength(
      formData,
      "Third party registration",
      8,
      "accident_third_party_regno",
    ),
    ThirdPartyOwner: validateMaxLength(
      formData,
      "Third party owner",
      30,
      "accident_third_party_owner",
    ),
    ThirdPartyTelephone: validateMaxLength(
      formData,
      "Third party telephone",
      30,
      "accident_third_party_tel",
    ),
    DamageDescription: validateMaxLength(
      formData,
      "Accident damage description",
      60,
      "accident_damage_description",
    ),
...
function getLossUpdate(formData: FormData): LossEditUpdate {
  return {
    ...
    DepartmentContact: validateMaxLength(
      formData,
      "Loss department contact",
      100,
      "loss_department_contact",
    ),
...
function getTowingUpdate(formData: FormData): TowingEditUpdate {
  return {
    ...
    ContactPersonName: validateMaxLength(
      formData,
      "Towing contact person",
      30,
      "towing_contact_person_name",
    ),
    ContactPersonTel: validateMaxLength(
      formData,
      "Towing contact telephone",
      30,
      "towing_contact_person_tel",
    ),
