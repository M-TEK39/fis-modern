    ...
    public partial class Batch18SegmentEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    journal_detail_allocation_exception_code = table
                ...
                {
                    table.PrimaryKey(
                        "PK_journal_detail_allocation_exception",
                        x => x.journal_detail_allocation_exception_code
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    segment_group_code = table
                        .Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    segment_group_name = table.Column<string>(
                        type: "nvarchar(255)",
                        maxLength: 255,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    segment_part = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    segment_structure_map_code = table
                        .Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    segment_journal_detail_map_code = table
                ...
                {
                    table.PrimaryKey(
                        "PK_segment_journal_detail_map",
                        x => x.segment_journal_detail_map_code
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    journal_detail_type_segment_group_map_code = table
                        .Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                {
                    table.PrimaryKey(
                        "PK_journal_detail_type_segment_group_map",
                        x => x.journal_detail_type_segment_group_map_code
                    );
                    table.ForeignKey(
        ...
        {
            migrationBuilder.DropTable(name: "journal_detail_allocation_exception", schema: "dbo");
            ...
            migrationBuilder.DropTable(name: "segment_journal_detail_map", schema: "dbo");

            migrationBuilder.DropTable(name: "segment_scoa", schema: "dbo");

            migrationBuilder.DropTable(name: "segment_structure_map", schema: "dbo");

            migrationBuilder.DropTable(name: "segment_group", schema: "dbo");

            migrationBuilder.DropTable(name: "segment", schema: "dbo");
        }
    }
}
