    ...
    public partial class Batch22MiscEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    monthly_odo_code = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    derived_odo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    odometer_date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    trans_type = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    date_created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    date_updated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    created_by_user_code = table.Column<int>(type: "int", nullable: true),
                    modified_by_user_code = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    request_code = table.Column<short>(type: "smallint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    request_date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    request_name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ...
                    approved_name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    change_description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    sub_system_affected = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    tech_description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    tech_component_impact = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    operational_impact = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    approve_or_not = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    res_person = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    route_code = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    bas_responsibility_code = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    bas_object_code = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    start_route_location_name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    end_route_location_name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
