        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    class_number = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ConfigurationFilter = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ConfiguredValue = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PackagePath = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ConfiguredValueType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    date_created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    date_updated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    created_by_user_code = table.Column<int>(type: "int", nullable: true),
                    modified_by_user_code = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    surcharge_code = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    RegNo1 = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    RegNo2 = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Same = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    sys_parameters_code = table.Column<short>(type: "smallint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    database_version = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
