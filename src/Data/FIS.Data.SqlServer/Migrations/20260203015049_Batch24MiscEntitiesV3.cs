    ...
    public partial class Batch24MiscEntitiesV3 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Notify_list_code = table
                        .Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Notify_list_desc = table.Column<string>(
                        type: "nvarchar(255)",
                        maxLength: 255,
                        nullable: true
                    ),
                    Notify_email1 = table.Column<string>(
                        type: "nvarchar(255)",
                        maxLength: 255,
                        nullable: true
                    ),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "LeaseContractTermsComment", schema: "dbo");

            migrationBuilder.DropTable(name: "Notify_List", schema: "dbo");

            migrationBuilder.DropTable(name: "PrivHireFuel_card", schema: "dbo");

            migrationBuilder.DropTable(name: "profile_history", schema: "dbo");

            migrationBuilder.DropTable(name: "TS_Comment", schema: "dbo");

            migrationBuilder.DropTable(name: "TS_Error_Code", schema: "dbo");
