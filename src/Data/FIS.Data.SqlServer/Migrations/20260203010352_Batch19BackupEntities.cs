...
namespace FIS.Data.SqlServer.Migrations
{
    ...
    public partial class Batch19BackupEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Excess_Kilo_Tariff = table.Column<decimal>(
                        type: "decimal(18,2)",
                        nullable: true
                    ),
                    date_created = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    approver_name = table.Column<string>(
                        type: "nvarchar(255)",
                        maxLength: 255,
                        nullable: true
                    ),
                    approver_rank = table.Column<string>(
                        type: "nvarchar(255)",
                        maxLength: 255,
                        nullable: true
                    ),
                    approver_tel = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    ...
                    trip_reason = table.Column<string>(
                        type: "nvarchar(255)",
                        maxLength: 255,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table
                        .Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    xf_nom = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    xd_nom = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    user_status = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    ...
                    data_import = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    virtual_odo = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    month_end = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    user_access = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    ...
                    OS_Browser = table.Column<string>(
                        type: "nvarchar(255)",
                        maxLength: 255,
                        nullable: true
                    ),
                    ...
                    Access_str = table.Column<string>(
                        type: "nvarchar(255)",
                        maxLength: 255,
                        nullable: true
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "fleet_notes_bkp", schema: "dbo");

            migrationBuilder.DropTable(name: "fleet_notes_restore", schema: "dbo");

            migrationBuilder.DropTable(name: "InvalidSegmentNumbersUsed", schema: "dbo");

            migrationBuilder.DropTable(name: "Last_monthly_Tar", schema: "dbo");

            migrationBuilder.DropTable(name: "LeaseTariff", schema: "dbo");

            migrationBuilder.DropTable(name: "LeaseTariff_File", schema: "dbo");

            migrationBuilder.DropTable(name: "LeaseTariff_history", schema: "dbo");

            migrationBuilder.DropTable(name: "TripsWithoutRoutes_Backup", schema: "dbo");

            migrationBuilder.DropTable(name: "tyda", schema: "dbo");

            migrationBuilder.DropTable(name: "tyda1", schema: "dbo");

            migrationBuilder.DropTable(name: "user_access_old1", schema: "dbo");
        }
    }
}
