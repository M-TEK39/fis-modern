        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    reg_num = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ...
                    merchant_area = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    voucher_number = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    taxi_scandoc_code = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    vmf_code = table.Column<int>(type: "int", nullable: false),
                    image = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    period_begin = table.Column<DateTime>(type: "datetime2", nullable: true),
