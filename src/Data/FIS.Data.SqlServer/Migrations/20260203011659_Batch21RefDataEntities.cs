    ...
    public partial class Batch21RefDataEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    mf_code_code = table
                        .Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    mf_code_number = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
                    mf_code_name = table.Column<string>(
                        type: "nvarchar(255)",
                        maxLength: 255,
                        nullable: true
                    ),
                    mf_code_value_mask = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    mf_code_map_code = table
                        .Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    segment_journal_detail_map_code = table.Column<long>(
                        type: "bigint",
                        nullable: false
                    ),
                    mf_code_code = table.Column<int>(type: "int", nullable: false),
                    mf_code_value = table.Column<string>(
                        type: "nvarchar(255)",
                        maxLength: 255,
                        nullable: true
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "GG_Blocks", schema: "dbo");

            migrationBuilder.DropTable(name: "HistStatus", schema: "dbo");

            migrationBuilder.DropTable(name: "Merchant", schema: "dbo");

            migrationBuilder.DropTable(name: "mf_code_map", schema: "dbo");

            migrationBuilder.DropTable(name: "posting_year", schema: "dbo");

            migrationBuilder.DropTable(name: "mf_code", schema: "dbo");
        }
    }
}
